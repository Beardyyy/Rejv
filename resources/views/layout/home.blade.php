...
<main id="main">
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <h3>Where</h3>
                    <p>Downtown Center, Belgrade, Serbia</p>
                </div>
                <div class="col-lg-3">
                    <h3>When</h3>
                    <p>Almost 24/7<br>2018</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="speakers" class="wow fadeInUp">
        <div class="container">
            <div class="section-header">
                <h2>Party places</h2>
                <p>Here are some of our best clubs and festivals</p>
            </div>
    ...
    <section id="schedule" class="section-with-bg">
        <div class="container wow fadeInUp">
            <div class="section-header">
                ...
                <p>Here is our party schedules</p>
            </div>
    ...
    <section id="venue" class="wow fadeInUp">
        ...
        <div class="container-fluid">
            ...
            <div class="section-header">
                <h2>Party Venue</h2>
                <p>Party venue location info and gallery</p>
            </div>
                ...
                <div class="col-lg-6 venue-info">
                    <div class="row justify-content-center">
                        <div class="col-11 col-lg-8">
                            <h3>Downtown Center, Belgrade</h3>
